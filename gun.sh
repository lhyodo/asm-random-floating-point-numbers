...
nasm -f elf64 -l executive.lis -o executive.o executive.asm -gdwarf

echo "Assemble fill_random_array.asm"
nasm -f elf64 -l fill_random_array.lis -o fill_random_array.o fill_random_array.asm -gdwarf

echo "Assemble show_array.asm"
nasm -f elf64 -l show_array.lis -o show_array.o show_array.asm -gdwarf
...
gcc -c -Wall -m64 -fno-pie -no-pie -o main.o main.c -std=c17 -g

echo "compile quick_sort.c using the gcc compiler standard 2017"
gcc -c -Wall -no-pie -m64 -std=c17 -o quick_sort.o quick_sort.c -g

echo "Link object files using the gcc Linker standard 2017"
gcc -m64 -no-pie -o array-random.out executive.o main.o fill_random_array.o show_array.o quick_sort.o normalize_array.o -std=c17 -g

echo "Run the Random Array Program:"
gdb ./array-random.out
